...
_grSstDetectResources(void)
{
  ...
  de10BootStage("_grSstDetectResources: enter");

  initEnumHardware( 0 );
  de10BootStage("_grSstDetectResources: after initEnumHardware");
...
_GlideInitEnvironment( void )
{
  ...
  if ( _GlideRoot.initialized ) /* only execute once */
    return;
  de10BootStage("_GlideInitEnvironment: begin");
